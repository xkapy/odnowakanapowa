...
const Contact = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Dla zalogowanych użytkowników sprawdzamy tylko wiadomość
    if (isLoggedIn) {
      if (!formData.message?.trim()) {
        setErrors({ general: "Wpisz wiadomość." });
        return;
      }
    } else {
      // Dla niezalogowanych sprawdzamy wszystkie pola
              ...
              <div className="grid gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none cursor-text"
                          placeholder="Imię"
                        />
                      </div>
                ...
                {isLoggedIn && (
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">Witaj! Twoje dane kontaktowe są już zapisane. Wystarczy że napiszesz wiadomość.</p>
                  </div>
                )}
          ...
          <div className="divide-y divide-gray-200">
            <div className="flex gap-x-7 py-6">
              ...
              <div className="grow">
                ...
                <p className="mt-1 text-sm text-gray-500">Preferujesz pisanie maili?</p>
                <div className="flex items-center gap-x-2">
                  ...
                  <AnimatePresence>
                    {copied && (
                      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }} className="mt-2 text-xs text-green-600">
                        Skopiowano!
                      </motion.div>
                    )}
                  </AnimatePresence>
            ...
            <div className="flex gap-x-7 py-6">
              <LuPhone className="flex-shrink-0 size-6 mt-1.5 text-gray-800" />
              <div className="grow">
                <h3 className="font-semibold text-gray-800">Kontakt telefoniczny</h3>
                <p className="mt-1 text-sm text-gray-500">Zadzwoń do nas bezpośrednio.</p>
                <div className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800">
                  <a href="tel:+48785922680" className="hover:text-gray-800">
                    +48 785 922 680
                  </a>
                </div>
              </div>
            ...
            <div className="flex gap-x-7 py-6">
              ...
              <div className="grow">
                ...
                <p className="mt-1 text-sm text-gray-500">Sprawdź nasze najczęstsze pytania.</p>
                <Link to="/faq" className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800">
                  Zobacz FAQ
                </Link>
              </div>
            </div>
